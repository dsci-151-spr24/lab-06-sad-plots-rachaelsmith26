...
***Expand the graph so you can see more of the precision of the data. Filter the capture data so that is is easier to read and not so much overwhelming data.***
